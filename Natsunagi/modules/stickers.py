...
from Natsunagi import dispatcher, telethn as bot
...
@natsunagicmd(command="stickerid")
...
@natsunagicmd(command="kang", pass_args=True)
...
@natsunagicmd(command="getsticker")
...
@natsunagicmd(command="delsticker")
