...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("Natsunagi.modules." + text)
    except:
...
@natsunagicmd(command="listmodules")
@sudo_plus
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("Natsunagi.modules.", 1)[1]
