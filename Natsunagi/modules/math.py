...
SIMPLIFY_HANDLER = DisableAbleCommandHandler(
    "math", simplify, pass_args=True, run_async=True
)
FACTOR_HANDLER = DisableAbleCommandHandler(
    "factor", factor, pass_args=True, run_async=True
)
DERIVE_HANDLER = DisableAbleCommandHandler(
    "derive", derive, pass_args=True, run_async=True
)
INTEGRATE_HANDLER = DisableAbleCommandHandler(
    "integrate", integrate, pass_args=True, run_async=True
)
ZEROES_HANDLER = DisableAbleCommandHandler(
    "zeroes", zeroes, pass_args=True, run_async=True
)
TANGENT_HANDLER = DisableAbleCommandHandler(
    "tangent", tangent, pass_args=True, run_async=True
)
...
ARCCOS_HANDLER = DisableAbleCommandHandler(
    "arccos", arccos, pass_args=True, run_async=True
)
ARCSIN_HANDLER = DisableAbleCommandHandler(
    "arcsin", arcsin, pass_args=True, run_async=True
)
ARCTAN_HANDLER = DisableAbleCommandHandler(
    "arctan", arctan, pass_args=True, run_async=True
)
