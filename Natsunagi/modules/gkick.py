...
from Natsunagi import dispatcher, OWNER_ID, DEV_USERS, DEMONS, GBAN_LOGS, DRAGONS
...
from Natsunagi.modules.no_sql.users_db import get_all_chats
import Natsunagi.modules.sql.global_kicks_sql as sql
...
def gkickset(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        ...
        return  
    if int(user_id) in DEMONS or int(user_id) in DRAGONS:
