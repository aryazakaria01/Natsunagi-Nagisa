...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Natsunagi.events

        path = Path(f"Natsunagi/modules/{shortname}.py")
        name = "Natsunagi.modules.{}".format(shortname)
        ...
        mod.Natsunagi = Natsunagi
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["Natsunagi.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Natsunagi/modules/*.py"
